...
data = dict(
    ...
    train=dict(
        type='CBGSDataset',
        data_root=data_root,
        ann_file='/home/lk/bevdetimg/data/nuscenes/bevdetv2-nuscenes_infos_train.pkl',
        ...
        dataset=dict(
            data_root=data_root,
            ann_file=
            data_root+'bevdetv2-nuscenes_infos_train.pkl',
            pipeline=train_pipeline,
            classes=class_names,
            test_mode=False,
            use_valid_flag=True,
    ...
    val=dict(
        ...
        data_root=data_root,
        ann_file=
        data_root+'bevdetv2-nuscenes_infos_val.pkl',
...
test_data_config = dict(
    ...
    ann_file='/home/lk/bevdetimg/data/nuscenes/bevdetv2-nuscenes_infos_val.pkl',
    type='NuScenesDataset',
    classes=[
        'car', 'truck', 'construction_vehicle', 'bus', 'trailer', 'barrier',
        'motorcycle', 'bicycle', 'pedestrian', 'traffic_cone'
...
work_dir = '/home/lk/bevdetimg/work_dir/bevdet180'
load_from = '/home/lk/bevdetimg/work_dir/bevdet180/epoch_1_ema.pth'
resume_from = None
workflow = [('train', 1)]
gpu_ids = range(0, 3)
