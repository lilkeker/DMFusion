...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
        data_root='/data8T/dataset/yy_dataset/nuscenes_bevdet/',
        ann_file= '/data8T/dataset/yy_dataset/nuscenes_bevdet/bevdetv2sweep10-nuscenes_infos_train.pkl',
...
work_dir = '/home/lk/bevdetimg/work_dir/swint_bevdet'
load_from = '/home/lk/bevdetimg/work_dir/swint_bevdet4d_cp_depthloss/epoch_3.pth'
evaluation = dict(
    interval=1,
    pipeline=[
        dict(
