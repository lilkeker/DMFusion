...
model = dict(
    ...
    img_bev_encoder_backbone=dict(
        type='CustomResNet', numC_input=(256 * 3) + 64, num_channels=[160, 320, 640]),
    img_bev_encoder_neck=dict(
        type='FPN_LSS', in_channels=800, out_channels=256),
    fuser=dict(type='SEFuser', in_channels=512+256, out_channels=512),
...
work_dir = '/home/yy/bevdet/work_dir/bevdet_TF_3frame_depthlss_3DCONV'

load_from = '/home/yy/bevdet/work_dir/test_bda_TF/epoch_4.pth'
