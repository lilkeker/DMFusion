...
work_dir = '/home/yy/bevdet/work_dir/bevdet4d_CP_2frame_nodepthlss'
load_from = '/home/yy/bevdet/work_dir/bevdet4d_CP_2frame_depthlss/epoch_2.pth'
custom_hooks = [
    dict(
