...
train_pipeline = [
    ...
    dict(type='LoadAnnotationsforDBSAMPLE', is_train=True),
    dict(
...
work_dir = '/home/yy/bevdet/work_dir/bevdet_TF_5frame_depthlss_BDA'

load_from = '/home/yy/bevdet/work_dir/bevdet_TF_5frame_depthlss/epoch_8.pth'
