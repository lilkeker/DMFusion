# -*- coding: utf-8 -*-
# LuKe
# File  : lidar_tf_nuscenespkl_trans2ego.py
# Time  : 2023/6/6 16:21
...
# test_pipeline = [
#     dict(type='PrepareImageInputs', data_config={
#     'cams': [
...
custom_imports = dict(
    imports=['hfai_script.Hfai_iter_based_runner', 'hfai_script.hfai_checkpoint'],
    allow_failed_imports=False)
# runner = dict(type='HfaiIterBasedRunner', max_iters=20 * 8007)
# checkpoint_config = dict(type='HfaiHook', by_epoch=False, interval=8007)  # 权重保存的轮次
# log_config = dict(
#     interval=50,
...
log_level = 'INFO'
work_dir = "/home/lk/bevdetimg/work_dir/lidar_tf_nuscenespkl_trans2ego"
load_from = None
resume_from = None
workflow = [('train', 1)]


runner = dict(type='MYEpochBasedRunner', max_epochs=5)
checkpoint_config = dict(interval=1)
log_config = dict(
    interval=50,
    hooks=[dict(type='TextLoggerHook'),
...
custom_imports = dict(
    ...
    allow_failed_imports=False)
#
# runner = dict(type='HfaiIterBasedRunner', max_iters=12 * 1759)
