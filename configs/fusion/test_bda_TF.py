...
train_pipeline = [
    ...
    dict(
        ...
        grid_config=dict(
            ...
            z=[-5, 3, 8],
            depth=[1.0, 60.0, 0.5])),
    dict(type='PointToEGO', downsample=1, grid_config=None),    # bev_aug
    dict(
...
data = dict(
    ...
    test=dict(
        ...
        data_root='/data0/yy_datasets/nuscenes_bevdet/',
        ann_file=
        '/data0/yy_datasets/nuscenes_bevdet/bevdetv2sweep10-nuscenes_infos_test.pkl',
        pipeline=test_pipeline,
        classes=[
            'car', 'truck', 'construction_vehicle', 'bus', 'trailer',
            'barrier', 'motorcycle', 'bicycle', 'pedestrian', 'traffic_cone'
...
work_dir = '/home/yy/bevdet/work_dir/test_bda_TF'
