...
data = dict(
    ...
    train=dict(
        ...
        data_root='/data8T/dataset/yy_dataset/nuscenes_bevdet/',
        ann_file=
        '/data8T/dataset/yy_dataset/nuscenes_bevdet/nuscenes_infos_train.pkl',
        pipeline=[
            dict(
                type='LoadPointsFromFile',
                coord_type='LIDAR',
...
work_dir = '/home/lk/bevdetimg/work_dir/bevfusion_CP'
load_from = '/home/lk/BEVDet4D/pretrianed/fusion_pretrained/fusion_need/fusion_cp.pth'
# load_lift_from = '/home/lk/BEVDet4D/pretrianed/fusion_pretrained/bevdet-r50-4d-cbgs.pth'
gpu_ids = range(0, 2)
