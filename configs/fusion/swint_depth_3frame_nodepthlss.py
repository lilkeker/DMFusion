...
model = dict(
    ...
    fuser_final=dict(type='SEFuser', in_channels=768, out_channels=512),
...
work_dir = '/home/lk/bevdetimg/work_dir/imgtrained_swint_3frame_fusion'
load_from = '/home/lk/bevdetimg/work_dir/swint_bevdet——depthloss/epoch_4.pth'
