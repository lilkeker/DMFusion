...
# from mmdet3d.datasets.registry import OBJECTSAMPLERS
...
https://github.com/open-mmlab/mmcv/blob/master/mmcv/fileio/file_client.py
    ...
    def filter_point_by_angle(self, points):
        ...
        # point = o3d.utility.Vector3dVector(points[:, 0:3])
        # pcl.points = point
        # pcl.paint_uniform_color([0.5, 0.5, 0.5])
        # np.asarray(pcl.colors)[filt] = [1, 0, 0]
