...
class RandomFlip3D(RandomFlip):
    ...
    def __call__(self, input_dict):
        ...
        # points = Coord3DMode.convert_point(input_dict['points'] , Coord3DMode.LIDAR,
        #                                               Coord3DMode.DEPTH)
        # gt_boxes = input_dict['gt_bboxes_3d']
        # gt_boxes = np.array(gt_boxes.tensor)
        # gt_bboxes_3d = Box3DMode.convert( gt_boxes, Box3DMode.LIDAR,
        #                              Box3DMode.DEPTH)
        #
        #
        # show_result(points.tensor[:, :3], gt_bboxes_3d, pred_bboxes=None,
        #             out_dir='/home/lk/bevdetimg/after_randomflip', filename='after_filp_aug',
        #             show=False, )
        return input_dict
...
class ObjectSample(object):
    ...
    def __call__(self, input_dict):
        ...
        #
        #
        # sampled_points = Coord3DMode.convert_point(sampled_points, Coord3DMode.LIDAR,
        #                                               Coord3DMode.DEPTH)
        #
        # sampled_gt_bboxes_3d = Box3DMode.convert(sampled_gt_bboxes_3d, Box3DMode.LIDAR,
        #                              Box3DMode.DEPTH)
        #
        #
        # show_result(sampled_points.tensor[:, :3], sampled_gt_bboxes_3d, pred_bboxes=None,
        #             out_dir='/home/lk/bevdetimg/after_aug_vis', filename='sampled_object',
        #             show=False, )
        #
        # ##################################################################
        #
        # points_all = Coord3DMode.convert_point(input_dict['points'], Coord3DMode.LIDAR,
        #                                               Coord3DMode.DEPTH)
        # gt_bboxes_3d_all = input_dict['gt_bboxes_3d']
        # gt_bboxes_3d_all = np.array(gt_bboxes_3d_all.tensor)
        # gt_bboxes_3d_all = Box3DMode.convert(gt_bboxes_3d_all, Box3DMode.LIDAR,
        #                                Box3DMode.DEPTH)
        #
        # show_result(points_all.tensor[:, :3], gt_bboxes_3d_all, pred_bboxes=None,
        #             out_dir='/home/lk/bevdetimg/after_aug_vis', filename='sampled_all_object',
        #             show=False, )
...
class GlobalRotScaleTrans(object):
    ...
    def __call__(self, input_dict):
        ...
        # ###### 以下是可视化
        #
        # points_1 = Coord3DMode.convert_point(input_dict['points'], Coord3DMode.LIDAR,
        #                                    Coord3DMode.DEPTH)
        # gt_boxes_1 = input_dict['gt_bboxes_3d']
        # gt_boxes_1 = np.array(gt_boxes_1.tensor)
        # gt_boxes_1 = Box3DMode.convert(gt_boxes_1, Box3DMode.LIDAR,
        #                                  Box3DMode.DEPTH)
        #
        # show_result(points_1.tensor[:, :3], gt_boxes_1, pred_bboxes=None,
        #             out_dir='/home/lk/bevdetimg/before_aug_vis', filename='before_aug',
        #             show=False, )
        ...
        # ###### 以下是可视化
        #
        # points2 = Coord3DMode.convert_point(input_dict['points'], Coord3DMode.LIDAR,
        #                                    Coord3DMode.DEPTH)
        # gt_boxes2 = input_dict['gt_bboxes_3d']
        # gt_boxes2 = np.array(gt_boxes2.tensor)
        # gt_bboxes_3d2 = Box3DMode.convert(gt_boxes2, Box3DMode.LIDAR,
        #                                  Box3DMode.DEPTH)
        #
        # show_result(points2.tensor[:, :3], gt_bboxes_3d2, pred_bboxes=None,
        #             out_dir='/home/lk/bevdetimg/after_aug_vis', filename='after_rot_aug',
        #             show=False, )
        ...
        # ###### 以下是可视化
        #
        # points3 = Coord3DMode.convert_point(input_dict['points'], Coord3DMode.LIDAR,
        #                                    Coord3DMode.DEPTH)
        # gt_boxes3 = input_dict['gt_bboxes_3d']
        # gt_boxes3 = np.array(gt_boxes3.tensor)
        # gt_bboxes_3d3 = Box3DMode.convert(gt_boxes3, Box3DMode.LIDAR,
        #                                  Box3DMode.DEPTH)
        #
        # show_result(points3.tensor[:, :3], gt_bboxes_3d3, pred_bboxes=None,
        #             out_dir='/home/lk/bevdetimg/after_aug_vis', filename='after_scale_aug',
        #             show=False, )
        self._trans_bbox_points(input_dict)
        # ###### 以下是可视化
        #
        # points4 = Coord3DMode.convert_point(input_dict['points'], Coord3DMode.LIDAR,
        #                                     Coord3DMode.DEPTH)
        # gt_boxes4 = input_dict['gt_bboxes_3d']
        # gt_boxes4 = np.array(gt_boxes4.tensor)
        # gt_bboxes_3d4 = Box3DMode.convert(gt_boxes4, Box3DMode.LIDAR,
        #                                   Box3DMode.DEPTH)
        #
        # show_result(points4.tensor[:, :3], gt_bboxes_3d4, pred_bboxes=None,
        #             out_dir='/home/lk/bevdetimg/after_aug_vis', filename='after_trans_aug',
        #             show=False, )
